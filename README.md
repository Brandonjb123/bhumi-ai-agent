...
Full-stack AI chatbot web app built with **Python**, **Streamlit**, and **Groq API**.

🌐 **Live Demo:** [bhumi-ai-agent.streamlit.app](https://bhumi-ai-agent-c3wmavfhyhnadhlkbbfneh.streamlit.app/)
...
3. Buat file `.env` berisi `GROQ_API_KEY=your_groq_api_key_here`
4. Jalankan: `streamlit run app.py`

---

👨‍💻 Dibuat oleh **Brandon** | Portfolio AI Engineer | 2026
